"""
DAWN v17.1: Hierarchical Neuron Circuits + v16-style Langevin Excitability

Core Architecture (from v17.0):
  2-level routing:
    Level 1: Circuit selection (top-k from n_circuits)
    Level 2: Neuron weighting within circuit (softmax)
  Circuit = team of cooperating neurons [neurons_per_circuit × d_model]

Excitability (from v16.1):
  - usage_ema_* : EMA-based usage tracking per circuit
  - excitability_weight_* : Per-circuit Langevin weights
  - update_excitability_weight() : dw = -α*w + β*dead_ratio
  - Consistent naming with v16.1 for easier maintenance
"""
...
class DAWN(nn.Module):
    ...
    v17.1 adds v16-style Langevin excitability (usage_ema_*, excitability_weight_*)
    """
    __version__ = "17.1"
