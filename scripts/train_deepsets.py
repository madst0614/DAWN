...
def main():
    ...
    parser.add_argument('--sparse_k', type=int, default=256, help='Number of neurons to select')
    parser.add_argument('--d_neuron', type=int, default=64, help='Neuron info vector size (DeepSets)')
    parser.add_argument('--d_hidden', type=int, default=128, help='φ output size (DeepSets)')
