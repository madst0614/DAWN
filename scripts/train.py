...
def main():
    ...
    if model_version != 'baseline':
        ...
        if model_version == "9.0":
            # v9.0: Per-type Input neurons (Q/K/V/M each 1), shared Output
            ...
            print(f"    - input_neuron_q: {args.d_model} × {rank}")
            print(f"    - input_neuron_k: {args.d_model} × {rank}")
            print(f"    - input_neuron_v: {args.d_model} × {rank}")
            print(f"    - input_neuron_m: {args.d_model} × {rank}")
            ...
            print(f"    - output_neuron: {rank} × {args.d_model} (shared)")
