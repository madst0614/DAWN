...
class DummyDataset(torch.utils.data.Dataset):
    """
    Dummy dataset for quick testing and experiments.

    Creates random token sequences for MLM-style training.
    """
...
def create_dummy_dataset(num_samples: int, seq_len: int, vocab_size: int) -> DummyDataset:
    """
